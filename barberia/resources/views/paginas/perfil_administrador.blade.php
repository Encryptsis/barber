...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/agenda/administrador') }}">Mi Agenda</a>
                </li>
                <li class="nav-item">
    ...
    <section class="secciones" style="margin-top: 3.5rem;">
        ...
        <div class="text-center">
            <img src="../Imagenes/MichaelAguilar.jpeg" alt="Foto del Barbero" class="foto-barbero">
        </div>
        <div class="info-card">
            <div class="static-info">
                <strong>Nombre del Barbero:</strong> MichaelAguilar
            </div>
            <div class="static-info">
                <strong>Correo Electrónico:</strong> Michael@gmail.com
            </div>
            <div class="static-info">
