...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/agenda/facial') }}">Mi Agenda</a>
                </li>
                <li class="nav-item">
    ...
    <section class="secciones" style="margin-top: 3.5rem;">
        <h2 class="titulo-secciones">Perfil Faciales</h2>
        <div class="text-center">
            <img src="../Imagenes/baber3.jpeg" alt="Foto del Barbero" class="foto-barbero">
        </div>
        <div class="info-card">
            <div class="static-info">
                <strong>Nombre del Barbero:</strong> Paola
            </div>
            <div class="static-info">
                <strong>Correo Electrónico:</strong> paola:23@example.com
            </div>
            <div class="static-info">
                <strong>Teléfono:</strong> +34 144 456 789
